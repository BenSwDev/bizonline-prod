...
<html dir="rtl" lang="he">
    <head>
        ...
        <meta charset="utf-8">
        <link rel="stylesheet" href="<?=$_CURRENT_BASE?>assets/css/style.css?v=<?=time()?>">
...
<script>
	...
	<body class="level-<?=$_CURRENT_USER->access()?> <?=$_SESSION['menuc']? "menu-closed" : ""?>">
	<style>
					...
					?>
						<div class="alerts <?=$alerts || $alerts_wr?  "" : "none"?>">
							...
							<span>
								...
								<?}?>
								<a class="alerts-bell"  href="?page=orders&otype=order&orderStatus=active&sourceID=9999">
						...
						<style>
							.alerts {text-decoration:none;position: absolute;left: 0;width: 60px;height: 100%;display: flex;top: 0;align-items: center;justify-content: center;}
...
?>
                    ...
                    <a href="logout.php" class="logout"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41 31" width="41" height="31"><path class="shp0" d="M7.9 17.2L27.9 17.2C28.9 17.2 29.6 16.4 29.6 15.5 29.6 14.6 28.9 13.8 27.9 13.8L7.9 13.8 10.1 11.6C10.8 10.9 10.8 9.8 10.1 9.2 9.5 8.5 8.4 8.5 7.7 9.2L2.5 14.3C2.5 14.3 2.4 14.4 2.4 14.4 2.4 14.4 2.4 14.4 2.4 14.5 2.3 14.5 2.3 14.5 2.3 14.6 2.3 14.6 2.3 14.6 2.3 14.6 2.3 14.6 2.2 14.7 2.2 14.7 2.2 14.7 2.2 14.7 2.2 14.7 2.2 14.8 2.2 14.8 2.1 14.8 2.1 14.9 2.1 14.9 2.1 14.9 2.1 14.9 2.1 15 2.1 15 2.1 15 2.1 15 2.1 15 2.1 15.1 2 15.1 2 15.2 2 15.2 2 15.2 2 15.2 2 15.3 2 15.3 2 15.3 2 15.4 2 15.4 2 15.5 2 15.6 2 15.6 2 15.7 2 15.7 2 15.8 2 15.8 2 15.8 2 15.8 2 15.8 2 15.9 2.1 15.9 2.1 16 2.1 16 2.1 16 2.1 16 2.1 16.1 2.1 16.1 2.1 16.1 2.1 16.2 2.1 16.2 2.1 16.2 2.2 16.2 2.2 16.2 2.2 16.3 2.2 16.3 2.2 16.3 2.2 16.3 2.2 16.4 2.3 16.4 2.3 16.4 2.3 16.4 2.3 16.4 2.3 16.5 2.3 16.5 2.3 16.5 2.4 16.6 2.4 16.6 2.4 16.6 2.4 16.6 2.4 16.6 2.5 16.7 2.5 16.7L7.7 21.8C8 22.2 8.5 22.4 8.9 22.4 9.4 22.4 9.8 22.2 10.1 21.8 10.8 21.2 10.8 20.1 10.1 19.4L7.9 17.2ZM25.9 1.5C21.2 1.5 16.8 3.8 14.1 7.7 13.6 8.5 13.8 9.6 14.6 10.1 15.4 10.6 16.5 10.4 17 9.6 19 6.7 22.3 4.9 25.9 4.9 31.8 4.9 36.6 9.7 36.6 15.5 36.6 21.3 31.8 26.1 25.9 26.1 22.3 26.1 19 24.3 17 21.4 16.5 20.6 15.4 20.4 14.6 21 13.8 21.5 13.6 22.6 14.2 23.3 16.8 27.2 21.2 29.5 25.9 29.5 33.7 29.5 40 23.2 40 15.5 40 7.8 33.7 1.5 25.9 1.5Z"></path></svg>יציאה</a>
                </div>
