...
$(function() {
    ...
    $('.item.order .f').on('click', function(e) {
...
function openPayOrder(data){
	...
	$.post('ajax_payOrder.php',{data:data, new:ssd_new},function(res){
        ...
        $('#ccorcash').off('change').on('change', function(){
            ...
            $('.manuy-number').css('display', (this.value == 'member' || this.value == 'member2') ? 'inline-block' : 'none').find('select, input').val('');
