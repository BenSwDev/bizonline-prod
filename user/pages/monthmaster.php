...
?>
      <tr>
         <td style="line-height:1"><span>סה"כ טיפולים:</span> <?=count($orders)?></td>
         <td></td>
         <td></td>
         <td></td>
	...
	<?if($collect['weekday']){?>
	  <tr>
         <td style="line-height:1"><span>סה"כ אמצ"ש</span> <?=$ctotal['weekday']['cnt']?></td>
         <td></td>
         <td></td>
         <td>
		 <?
		 foreach($collect['weekday'] as $key => $treats){?>
			<?=$key?> <span>דק'</span> - <?=$treats['cnt'];?><br>
		 <?}
		 ?>
		 </td>
         <td></td>
	...
	<?if($collect['weekend']){?>
	  <tr>
         <td style="line-height:1"><span>סה"כ סופ"ש</span> <?=$ctotal['weekend']['cnt']?></td>
         <td></td>
         <td></td>
         <td>
		 <?
