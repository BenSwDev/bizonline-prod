    ...
    <div class="priceTable">
        ...
        <table>
            ...
            <tr>
                <td>לאחר השעה</td>
                <td>
                    <select  name="ExtraPriceAfterTime" id="ExtraPriceAfterTime">
                ...
                <td><input type="tel" name="ExtraPriceAfterPrice" id="ExtraPriceAfterPrice" value="<?=$extraPriceAfter['ExtraPriceAfterPrice']?>"><span class="shekel">₪</span></td>
                <td></td>
            </tr>
