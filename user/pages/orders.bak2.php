...
elseif ($_GET['orderStatus'] == 'cancel'){
    $que .= " AND `orders`.`status` = 0 AND (orders.apiSource <> 'spaplus' OR orders.sourceID <> 'spaplus')";       // not showing order that came from Spaplus (request by Roy 05.11.2024 19:39)
    $title .= " מבוטלות";
}
