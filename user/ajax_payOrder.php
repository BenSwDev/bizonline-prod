<?php
if ($_SERVER['HTTP_X_FORWARDED_FOR'] == '2a00:a041:e9c5:9d00:c13d:a70c:ea15:a5b8'){
    include_once "ajax_payOrderSerg.php";
    echo 'aaa';
    return;
}
    ...
    <div class="sendPop" id="dsPop" style="display:none">
        ...
        <div class="container">
            ...
            <div class="content">
                <div class="lines">
                    <div class="line">
                        <input type="text" id="sharePhone" placeholder="מספר טלפון">
                        <div class="signOpt">
