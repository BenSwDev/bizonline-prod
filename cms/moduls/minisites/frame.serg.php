...
?>
				<div class="domain" data-id="<?=$id?>">
					...
					<div class="inputLblWrap">
						<label class="switch">
						  <input type="checkbox" name="active" value="1" <?=($siteDomains[$id]['active'] ? 'checked="checked"' : '')?> />
...
?>
				<div class="language" data-id="<?=$lid?>">
					<div class="section txtarea big">
						...
						<textarea name="shortDesc" class="textEditor" title=""><?=$siteLangs[$id][$lid]['shortDesc']?></textarea>
					</div>
				</div>
<?php
        }
