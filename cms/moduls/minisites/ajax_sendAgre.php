...
$phone = $site['phone'];
$smsMsg = "להלן קישור להסכם - https://bizonline.co.il/agreement2.php?guid=".$site['guid'];
...
$message .= "<div style='direction:rtl;clear:both'><a href=\"https://bizonline.co.il/agreement2.php?guid=".$site['guid']."\">להלן קישור להסכם</a>";
