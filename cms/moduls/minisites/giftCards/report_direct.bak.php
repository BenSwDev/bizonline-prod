...
<table class="giftcards-log" id="exp_xl" cellspacing="0">
    <thead>
        <tr>
            ...
            <th style="width:120px">מספר שוברים</th>
            <th style="width:120px">סכום כולל</th>
            <th style="width:120px">סכום מימושים</th>
            <th style="width:120px">סך יתרות</th>
            <th style="width:120px">עמלת ממוצע</th>
            <th style="width:120px">סה"כ עמלה</th>
            <th style="width:120px">שולם</th>
        </tr>
    </thead>
    <tbody>
<?php
/*        $sql = "select siteID,giftCardCommission from sites ";
        ...
        $que = "SELECT sites.siteID, sites.siteName, sites.giftCardCommission, sites.bankName, sites.bankNumber, sites.bankBranch, sites.bankAccount, sites.bankAcoountOwner,
                    COUNT(DISTINCT gifts_purchases.pID) AS `totalCards`, SUM(gifts_purchases.sum) AS `totalPaid`, SUM(gifts_purchases.commSum) AS `total_commissions`, AVG(gifts_purchases.commPrec) AS `avgPerc`,
...
?>
                ...
                <td><?=smartNF($item['totalPaid'] - $item['mimushSum'])?></td>
...
<?php
        $totals['left'] = $totals['totalPaid'] - $totals['mimushSum'];
...
<table cellspacing="0" id='exp_xl2'>
    <thead>
        <tr>
            ...
            <th style="width:80px">סכום השובר</th>
            <th style="width:80px">סכום המימוש</th>
