...
//    }
    ...
    <tbody>
        ...
        foreach($list as $item) {
            ...
            <td style="text-align:right;width: 170px"><?=$item['title']?></td>
            ...
            <td width="100" style="text-align:right;"><?
                ...
                ?></td><?
                    $useExpirationDate = date("d/m/Y", strtotime(" +".$item['daysValid']." months", strtotime($item['transDate'] ? $item['transDate'] : date("Y-m-d"))));
