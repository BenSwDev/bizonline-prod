...
?>
            ...
            <div class="inputWrap half">
                <input type="text" name="createDate" placeholder="תאריך הפקה מ" class="searchFrom" value="<?=UtilsDate::db2date($createDate)?>" readonly />
            </div>
            <div class="inputWrap half">
                <input type="text" name="createDateTo" placeholder="תאריך הפקה עד" class="searchFrom" value="<?=UtilsDate::db2date($createDateTo)?>" readonly />
            </div>
            <div class="inputWrap half">
                <input type="text" name="usingDate" placeholder="תאריך מימוש מ" value="<?=UtilsDate::db2date($useDate)?>" class="searchTo" readonly />
            </div>
            <div class="inputWrap half">
                <input type="text" name="usingDateTo" placeholder="תאריך מימוש עד" value="<?=UtilsDate::db2date($useDateTo)?>" class="searchTo" readonly />
            </div>
            <div class="inputWrap">
...
?>
    ...
    <thead>
        <tr>
            ...
            <!-- th>הזמנה</th -->
            <th style="width:80px;">עלות</th>
            <th style="width:80px;">עמלה</th>
            <th style="width:100px;">סכום עמלה</th>
            <th style="width:120px">ת. מימוש</th>
            <th style="width:80px;">שווי</th>
            <th style="width:80px;">מימוש</th>
            <th style="width:80px;">יתרה</th>
...
?>
            ...
            <td><?=date("d/m/Y", strtotime($item['reciveTime'] . " +".($item['validMonths'] ?: $item['daysValid'])." months"))?></td>
        </tr>
<?php
		$totals['paidSum'] += round($item['sum'] - $item['actualDiscount']);
