...
?>
    ...
    <div class="editItems actions" >
        ...
        <select class="domSelectorcopy"  style="display: none;">
            ...
            <button class="sub"  id="copyAttrs" style="display: none;width:200px;">העתק נתונים</button>
        <?}?>
    </div>
	<div class="editItems">
		<h1><?=$menuList?></h1>
...
$('.dd').on('change', function() {
   saveAll();
    ...
    .mainCtrl {margin-right: 10px;overflow: auto;position: relative;max-height: calc(100vh - 120px);min-width:1200px}
