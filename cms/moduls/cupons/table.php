...
?>
    ...
    <div class="manageItems" id="manageItems">
        ...
        <button class=" submit" onclick="openPop(0)" style="padding:5px;margin:0 7px;">הוסף קופון</button>
        <table>
            <thead>
            <tr>
                <th>#</th>
...
//                $used += udb::single_value("select count(cuponNumber) from pack_purchases where cuponNumber='".$cupon['cCode']."' and ordersID != 0");
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a data-id="<?=$cupon['id']?>" class="edit-item submit" onclick="openPop(<?=$cupon['id']?>)" style="padding:5px;margin:0 7px;">ערוך</a>
                    </td>
